...
/**
 * 序列类，用于封装曲线数据或者生成时间序列
 *
 * @author lsd
 * @version 1.0
 * @date 2024/7/10 14:00
 */
public class Series<K, V> implements NavigableMap<K, V>, Serializable {
    ...
    public Series(final Class<K> classK, final Class<V> classV) {
        Preconditions.require(classK != null, "Generic type <K> is null");
        Preconditions.require(classV != null, "Generic type <V> is null");
