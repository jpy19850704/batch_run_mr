 ...
 * 只保留正式场景生成入口。
 */
public class ScenarioExecutionAdapter implements ExecutionAdapter {
    private static final Logger log = LoggerFactory.getLogger(ScenarioExecutionAdapter.class);
    ...
    public ScenarioExecutionAdapter(
