...
CREATE TABLE IF NOT EXISTS MR_IMA_RISK_FACTOR_CONFIG_SNAPSHOT (
    batch_id VARCHAR(128) NOT NULL,
    data_date DATE NOT NULL,
    update_time TIMESTAMP NOT NULL,
    curve_code VARCHAR(128) NOT NULL,
    ...
    CONSTRAINT pk_MR_IMA_RISK_FACTOR_CONFIG_SNAPSHOT PRIMARY KEY (batch_id, curve_code)
);

CREATE INDEX IF NOT EXISTS idx_MR_IMA_RISK_FACTOR_CONFIG_SNAPSHOT_curve
    ON MR_IMA_RISK_FACTOR_CONFIG_SNAPSHOT (batch_id, curve_type, curve_code);
